        ...
        <div class="main-container">
            ...
            <div class="user-header">
                ...
                <div class="sync-status">
                    <!-- Status synced -->
                    <div v-if="syncStatus === 'synced'" class="status-indicator synced" title="Synchronisé">
                    ...
                    <!-- Status syncing -->
                    <div v-if="syncStatus === 'syncing'" class="status-indicator syncing"
                    ...
                    <!-- Status error -->
                    <div v-if="syncStatus === 'error'" class="status-indicator error"
                        title="Erreur de synchronisation - Cliquer pour réessayer" @click="retrySync">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                    ...
                    <!-- Status offline -->
                    <div v-if="syncStatus === 'offline'" class="status-indicator offline" title="Hors ligne">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                    ...
                    <span class="status-text">
                        <span v-if="syncStatus === 'synced'" class="synced-text">Synchronisé</span>
                        <span v-if="syncStatus === 'syncing'" class="syncing-text">En cours...</span>
                        <span v-if="syncStatus === 'error'" class="error-text">Erreur</span>
                        <span v-if="syncStatus === 'offline'" class="offline-text">Hors ligne</span>
                    </span>
                </div>
            ...
            <div class="content-area">
                    ...
                    <div class="card-creator">
                        ...
                        <div class="mood-selector">
                            ...
                            <div class="mood-options">
                                <button v-for="mood in moods" :key="mood.id" @click="selectedMood = mood"
                                    class="mood-btn" :class="{ 'selected': selectedMood?.id === mood.id }">
                        ...
                        <div class="text-input-section">
                            ...
                            <textarea v-model="cardText"
                                ...
                                class="card-textarea" :style="{ borderColor: currentUser?.color + '33' }"
                                rows="4"></textarea>
                            <div class="char-count" :class="{ 'limit-warning': cardText.length > 280 }">
                                {{ cardText.length }}/300
                            </div>
                        </div>
                ...
                <div class="timeline-section">
                    ...
                    <div class="timeline">
                        ...
                        <div v-for="card in cards" :key="card.id" class="timeline-card"
                            :class="{ 'processing': card.isProcessing, 'editing': editingCard?.id === card.id }">

                            <!-- Edit Mode -->
                            <div v-if="editingCard?.id === card.id" class="edit-mode">
                                ...
                                <div class="edit-mood">
                                    ...
                                    <div class="edit-mood-options">
                                        <button v-for="mood in moods" :key="mood.id" @click="editMood = mood"
                                            class="edit-mood-btn" :class="{ 'selected': editMood?.id === mood.id }">
                                            {{ mood.emoji }}
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div v-else>
                                <div class="card-header">
                                    <img :src="card.user.avatar" :alt="card.user.name" class="card-avatar" />
                                    <div class="card-meta">
                                    ...
                                    <div v-if="!card.isProcessing" class="card-actions">
                                        <button @click="startEditing(card)" class="action-btn edit-btn"
                                            title="Edit card">
                                        ...
                                        <button @click="deleteCard(card.id)" class="action-btn delete-btn"
                                            title="Delete card">
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2">
